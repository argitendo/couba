  ...
  return (
    <header
          ...
          >
            <div className='flex flex-col justify-center mobile-nav items-center text-3xl md:text-4xl font-serif-archivo font-black'>
              ...
              <div className='relative'>
                ...
                <div className='mt-4'>
                  <Link href='/login'>
                    <Button.SecondaryVariants customButton='py-4 px-20 w-full'>{navBaritems[5].title}</Button.SecondaryVariants>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <nav className='lg:flex flex-row items-center hidden font-serif-nutito text-left text-base font-sans-nutito'>
        <Link href={'/'} onClick={() => { closeMenu(); document.getElementById('how-to-screen').scrollIntoView() }} title={navBaritems[0].title} className={`mr-8 ${isSecondary ? 'text-white' : 'text-mainColor-tertiary'} cursor-pointer`}>{navBaritems[0].title}</Link>
        <Link href={'/'} onClick={() => { closeMenu(); document.getElementById('feature-screen').scrollIntoView(); }} title={navBaritems[1].title} className={`mr-8 ${isSecondary ? 'text-white' : 'text-mainColor-tertiary'} cursor-pointer`}>{navBaritems[1].title}</Link>
        <Link href={'/'} onClick={() => { closeMenu(); document.getElementById('accessories-screen').scrollIntoView(); }} title={navBaritems[2].title} className={`mr-8 ${isSecondary ? 'text-white' : 'text-mainColor-tertiary'} cursor-pointer`}>{navBaritems[2].title}</Link>
        <Link href={'/'} onClick={() => { closeMenu(); document.getElementById('faq-screen').scrollIntoView(); }} title={navBaritems[3].title} className={`mr-[2rem] ${isSecondary ? 'text-white' : 'text-mainColor-tertiary'} cursor-pointer`}>{navBaritems[3].title}</Link>
        ...
        <div title={navBaritems[5].title}>
          <Link href='/login'>
            <Button.SecondaryVariants customButton='py-4 px-12'>{navBaritems[5].title}</Button.SecondaryVariants>
          </Link>
        </div>
      </nav>
